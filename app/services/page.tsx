...
export default function ServicesPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-brand-cream relative overflow-hidden">
      {/* Decorative Background Elements (Dashed Lines at Bottom) */}
      <div className="absolute bottom-0 left-0 right-0 h-32 opacity-50 pointer-events-none z-0 flex flex-col justify-end gap-2 pb-4">
        <div className="w-full h-2 bg-brand-coral/40 rounded-full mx-auto w-[90%]" />
        <div className="w-full h-2 bg-brand-coral/40 rounded-full mx-auto w-[80%] translate-x-4" />
        <div className="w-full h-2 bg-brand-coral/40 rounded-full mx-auto w-[95%] -translate-x-2" />
        <div className="w-full h-2 bg-brand-coral/40 rounded-full mx-auto w-[85%]" />
      </div>

      <div className="flex-1 flex items-center justify-center gap-6 px-6 z-10">
        {/* Bicihub Card */}
      ...
      {activeModal === "bicihub" && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setActiveModal(null)}
              className="absolute top-2 right-2 w-11 h-11 flex items-center justify-center bg-black/5 hover:bg-black/10 rounded-full transition-colors z-10"
            >
