        ...
        <>
            ...
            <div className="w-full h-full flex flex-col items-center justify-center relative p-4 gap-4">
                ...
                <div className="flex items-center justify-center w-full gap-4">
                    ...
                    {/* Main Card Container */}
                    <div
                        className="relative h-auto max-h-full w-auto aspect-[4/5] max-w-full rounded-3xl overflow-hidden shadow-soft flex flex-col shrink-1 min-h-0 transition-colors duration-500"
                        ...
                        <div className="mt-auto mx-3 mb-3 bg-brand-dark rounded-2xl p-3 flex gap-3 shadow-lg relative z-20">
                            ...
                            <div className="flex-1 flex flex-col justify-between min-w-0">
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className="text-[10px] text-brand-gray/80 underline decoration-brand-coral decoration-2 underline-offset-2 shrink-0">{currentEvent.subtitle}</span>
                                </div>
                                ...
                                <button
                                    ...
                                    className="mt-2 w-full text-brand-dark text-[10px] font-bold py-1.5 rounded-lg hover:bg-white transition-colors"
