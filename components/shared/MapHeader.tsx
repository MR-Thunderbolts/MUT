        ...
        <div className="w-full bg-brand-coral pt-12 pb-4 px-4 flex flex-col gap-4 shadow-md z-40 relative rounded-b-3xl">
            <div className="flex items-center justify-between px-2">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/tiendas" className="text-white/80 hover:text-white transition-colors">
                    ...
                    <Link href="/informaciones" className="text-white/80 hover:text-white transition-colors">
